...
public class RoosterConnection implements ConnectionListener {
    ...
    private static final String HOST = "167.99.95.234";
    ...
    public RoosterConnection(Context context) {
        ...
        if( jid != null) {
            ...
            // Service name from domain in jid: user@server.com -> server.com
    ...
    public void connect() throws IOException,XMPPException,SmackException {
        ...
        XMPPTCPConnectionConfiguration conf = XMPPTCPConnectionConfiguration.builder()
                ...
                // Makes connection insecure but we don't have to bother with security certificates..
